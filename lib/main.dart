...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    contatos.add(new Contato(
        nome: "João", telefone: "99879-8779", tipo: ContatoType.CELULAR
    ));
    contatos.add(new Contato(
        nome: "Lucas", telefone: "99879-8888", tipo: ContatoType.CELULAR
    ));
    contatos.add(new Contato(
        nome: "Thiago", telefone: "3337-9999", tipo: ContatoType.CASA
    ));
    contatos.add(new Contato(
        nome: "Mariana", telefone: "3379-9999", tipo: ContatoType.CASA
    ));
    contatos.add(new Contato(
        nome: "Beatriz", telefone: "98889-7777", tipo: ContatoType.FAVORITO
    ));
    contatos.add(new Contato(
